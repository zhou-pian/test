...
<div id="mid">
	...
	<form action="AddOrderServlet?userId=${user.userId }&bookId=${book.bookId }&num=${num }&money=${money }" method="post">
	<table align="center" height="200px">
		<tr>
			<td align="center">支付金额：${money }</td>
		</tr>
		<tr>
			<td align="left"><h1>支付密码：<input type="text"  name="payPassword"></h1></td>
		</tr>	
		<tr>
			<td align="center">
				<input type="submit" value="支付">
				<input type="button" value="取消" onclick="location='FindBookServlet?categoryId=100&userId=${user.userId }'">
			</td>
		</tr>
	</table>
	</form>			
